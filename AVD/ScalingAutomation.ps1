# Possible JSON Template from Jason Masten
# Would avoid using script, still need to do step 2 in portal for RunAs Acct.
# https://github.com/jamasten/Azure/tree/master/solutions/scalingAutomation
...
# 1. Create or update an Azure Automation account
# -------------------------------------------------------------------------------
...
# 2. Create RunAs Account in Portal before step 3
#----------------------------------------------------------------------------------------
<#   https://docs.microsoft.com/en-us/azure/virtual-desktop/set-up-scaling-script#create-an-azure-automation-run-as-account
    
    1. Open properties of Azure Automation Account from above
    2. In Left Pane select Run As Accounts
    3. Click Create and wait for deployment to complete
#>


# 3. Create the Azure Logic App and execution schedule
#----------------------------------------------------------------------------------------
