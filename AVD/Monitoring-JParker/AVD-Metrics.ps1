...
#    ASSUMING: 
#       Resource Group Names for Host pool - Contain "POOL-RG" in name
#       Log Analytics Workspace has Tag - AVD-Function : PROD
...
foreach ($subscription in $subscriptions) {
    ...
    $logAnalyticsWorkspace = (Query-Azure $logAnalyticsQuery $token).Value.Where{$_.Tags.'AVD-Function' -eq "PROD"}
